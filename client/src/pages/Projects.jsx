        ...
        <div className="flex-1 flex sm:flex-col gap-6 sm:gap-4">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              {/* Option A: Project uses the new structured 'links' object */}
                ...
                <>
                  {currentProject.links.github && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-tertiary font-medium hover:underline text-sm"
                    >
                      View Repository <i className="ri-github-line"></i>
                    </a>
                  )}
                  {currentProject.links.userApp && (
                    <a
                      href={currentProject.links.userApp}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-secondary font-medium hover:underline text-sm"
                    >
                      Live Application <i className="ri-external-link-line"></i>
                    </a>
                  )}
                  {currentProject.links.adminPortal && (
                    <a
                      href={currentProject.links.adminPortal}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-white bg-tertiary/20 border border-tertiary/40 px-2.5 py-0.5 rounded text-xs font-medium hover:bg-tertiary/30 transition-colors"
                    >
                      Admin Portal <i className="ri-shield-user-line"></i>
                    </a>
                  )}
                </>
              ) : (
                // Option B: Fallback for older projects using a single 'url' field
                currentProject.url && (
                  <a
