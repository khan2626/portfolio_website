...
function Intro() {
  ...
  return (
    <section
      id="intro"
      className="min-h-[55vh] sm:min-h-[40vh] flex flex-col justify-center items-center pb-6 sm:pt-2 sm:pb-2 px-2"
    >
      <div className="animate-fade-in-up text-center max-w-2xl mx-auto w-full">
        <p className="text-tertiary font-mono text-lg mb-3 tracking-widest uppercase">
          {welcomeText || "Hi there"}
        </p>
        <h1 className="text-5xl sm:text-3xl font-bold text-white leading-tight mb-0  sm:mb-6">
          I'm <span className="text-secondary">{name || ""}</span>
          <br />
          <span className="text-muted font-normal text-3xl sm:text-lg">
            but you can call me{" "}
        ...
        <p className="text-muted text-xl sm:text-lg mb-6 sm:mb-6">
          {description || ""}
        </p>
