...
function About() {
  ...
  return (
    <section id="about" className="py-0 sm:py-2">
      ...
      <div className="animate-fade-in-up sm:flex-col flex gap-6 sm:gap-4 justify-between items-center">
        ...
        <div className="sm:w-full flex-1 space-y-3 sm:space-y-2 text-muted leading-relaxed text-center text-md sm:text-base">
          <p>{description1}</p>
          <p>{description2}</p>
